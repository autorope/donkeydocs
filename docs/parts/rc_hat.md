...
To do so, you can either wire up it up manually as shown in [this tutorial](/parts/rc.md) (which works, but has a lot of fiddly wires that can fall off) or do it neatly with the Donkeycar RC hat, which handles all the wiring for you, along with including an OLED screen and a fan. 
