...
The complete set configuratino values and their defaults can be found in [donkeycar/templates/cfg_cv_control.py](https://github.com/autorope/donkeycar/blob/main/donkeycar/templates/cfg_cv_control.py) and is copied here for convenience.
...
Here is the complete custom cv autopilot part:
